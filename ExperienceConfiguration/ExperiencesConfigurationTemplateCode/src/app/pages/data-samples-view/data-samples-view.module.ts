...
import { DataSampleFileIconComponent } from './data-sample-preview-icon/data-sample-edit-icon-component'
import { DataSamplePlayIconComponent } from './data-sample-execute-icon/data-sample-edit-icon-component'
...
@NgModule({
  ...
  declarations: [
    ...
    DataSampleFileIconComponent,
    DataSamplePlayIconComponent,
