...
class SlurmGenerator:
    def __init__(self, main_path, generation_path, db_path, experience_id, experience_data, batch_size=100):
        ...
        self.slurm_parameters = {
            ...
            "assignment_simple": {"time": "00:20:00", "mem": "1G", "batch_size": 200},
            "assignment_milp": {"time": "05:00:00", "mem": "1G", "batch_size": 25},
            "scheduling_simple": {"time": "01:00:00", "mem": "1G", "batch_size": 200},
            "scheduling_combined": {"time": "02:00:00", "mem": "1G", "batch_size": 200},
            "scheduling_rhma": {"time": "05:00:00", "mem": "16G", "batch_size": 25},
        }
...
"""
    ...
    def generate_full_pipeline_slurm(self):
        ...
        command = (
            ...
            "  echo \"Not submitting after only taskset\"\n"
            "else\n"
